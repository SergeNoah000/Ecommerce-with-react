...
useEffect(() => {
  const fetchData = async () => {
    try {
      const response = await axios.get('http://localhost:8081/promotion');
  ...
  const deletePromo = async (id) => {
    try {
      await axios.delete(`http://localhost:8081/promotion/${id}`);
...
//   // const fetchData = async () => {
//   //   try {
//   //     const response = await axios.get('http://localhost:8081/PromotionForm');
...
//   // const deletePromo = async (id) => {
//   //   try {
//   //     await axios.delete(`http://localhost:8081/PromotionForm/${id}`);
