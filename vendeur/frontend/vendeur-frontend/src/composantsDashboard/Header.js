    ...
    const vendeurId = decodedToken.vendeurId; 
        ...
        const [data, setData] = useState([]);
            useEffect(() => {
                ...
                const result = await axios('http://localhost:3001/getVendeurById/'+ vendeurId);
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src={`http://localhost:3500/${data.profil}`} alt="Header Avatar"/>
