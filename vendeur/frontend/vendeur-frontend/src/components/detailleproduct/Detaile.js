                        ...
                        <div class="row gx-lg-5">
                            ...
                            <div class="col-xl-8">
                                <div class="mt-xl-0 mt-5">
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="p-2 border border-dashed rounded">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1">
                                                    <p className="text-muted mb-1"> Tommy Hilfiger men striped pink sweatshirt. Crafted with cotton. Material composition is 100% organic cotton. This is one of the world’s leading designer lifestyle brands and is internationally recognized for celebrating the essence of classic American cool style, featuring preppy with a twist designs. </p>
                                    ...
                                    <p className="subtitle is-4"> Tommy Hilfiger men striped pink sweatshirt. Crafted with cotton. Material composition is 100% organic cotton. This is one of the world’s leading designer lifestyle brands and is internationally recognized for celebrating the essence of classic American cool style, featuring preppy with a twist designs.</p>
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <div class="row align-items-center g-2">
                                                            ...
                                                            <div class="col">
                                                                <div class="p-2">
                                                                    <div class="progress bg-success-subtle animated-progress progress-sm">
                                                                        <div class="progress-bar bg-success" role="progressbar" aria-valuenow="19.32" aria-valuemin="0" aria-valuemax="100"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-auto">
                                                        ...
                                                        <div class="row align-items-center g-2">
                                                            ...
                                                            <div class="col">
                                                                <div class="p-2">
                                                                    <div class="progress bg-success-subtle animated-progress progress-sm">
                                                                        <div class="progress-bar bg-success" role="progressbar" aria-valuenow="18.12" aria-valuemin="0" aria-valuemax="100"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-auto">
                                                            ...
                                                            <div class="col">
                                                                <div class="p-2">
                                                                    <div class="progress bg-warning-subtle animated-progress progress-sm">
                                                                        <div class="progress-bar bg-warning" role="progressbar"  aria-valuenow="7.42" aria-valuemin="0" aria-valuemax="100"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col">
                                                                <div class="p-2">
                                                                    <div class="progress bg-danger-subtle animated-progress progress-sm">
                                                                        <div class="progress-bar bg-danger" role="progressbar"  aria-valuenow="4.98" aria-valuemin="0" aria-valuemax="100"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-auto">
