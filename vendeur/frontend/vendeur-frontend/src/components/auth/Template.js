...
const LoginComponent = () => {
  ...
  //         try {
  //         const response = await axios.post('http://localhost:3001/api/logvendeur', {
  //           nom: nom, 
  //           password: password 
  //         });
  ...
  //           //   .then(response => {
  //           //     setVendeurProducts(response.data.produits);
  //           //   })
  //           //   .catch(error => {
  //           //     // Gérer les erreurs de récupération des produits du vendeur
  //           //   });
  ...
  //       } catch (error) {
  //         setLoading(false);
  //         setErrorMessage("Nom d'utilisateur ou mot de passe inccorect"); 
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    setLoading(true);
    axios.post('http://localhost:3001/login', { nom, password })
      .then(response => {
                                        ...
                                        <div class="position-relative h-100 d-flex flex-column">
                                            ...
                                            <div class="carousel-inner text-center text-white-50 pb-5">
                                                        <div class="carousel-item active">
                                                            <p class="fs-15 fst-italic">VENDORS</p>
                                                        </div>
                                                    </div>
                                            <div class="mt-auto">
                                                <div class="mb-3">
